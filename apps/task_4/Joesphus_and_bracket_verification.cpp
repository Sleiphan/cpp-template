...
void run_syntax_check() {
    std::string files[] = {
        "./res/task_4/Correct_syntax_1.txt",
        "./res/task_4/Correct_syntax_2.txt",
        "./res/task_4/Wrong_syntax_1.txt",
        "./res/task_4/Wrong_syntax_2.txt",
        "./res/task_4/Wrong_syntax_3.txt",
        "./res/task_4/Wrong_syntax_4.txt"
    };
